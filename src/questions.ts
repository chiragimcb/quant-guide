...
export const TSD_QUESTIONS: Question[] = [
    {
        ...
        solutionLogic: "Total Distance / Total Time. Let distance one-way be D. Return time = (D/2)/30 + (D/2)/10."
    },
    {
        id: 2,
        year: "CAT 2019",
        ...
        solutionLogic: "Ratio of time taken is 4h : 4.5h (8:9). Ratio of speeds is 9:8. Calculate the meeting point based on the 1-hour head start."
    },
    {
        id: 3,
        year: "CAT 2021",
